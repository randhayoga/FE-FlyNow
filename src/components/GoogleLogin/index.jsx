...
const GoogleLoginComponent = ({ text }) => {
    ...
    return (
        ...
        className="block w-full py-2 px-4 text-dark transition-all rounded-md focus:outline-none"
        onClick={() => login()}
    >
    <div className="flex items-center justify-center gap-4 font-medium text-sm">
        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-6" viewBox="0 0 48 48">
...
//             className="block w-full py-2 px-4 bg-slate-200 hover:bg-slate-300 text-dark transition-all rounded-md focus:outline-none"
//             onClick={() => login()}
//         >
//             <div className="flex items-center justify-center gap-4 font-medium text-sm">
//                 <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-6" viewBox="0 0 48 48">
